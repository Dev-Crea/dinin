...
Devise.setup do |config|
  ...
  config.secret_key = '648c923d35e8e14223a6544152bd793d29a970684948cf81e28cb2a69
  0b41d02641b4d1675abc65f017d629be2616459d3ff0b8b88a777b2d2635633fa0aa4ad'

  # ==> Mailer Configuration
  # Configure the e-mail address which will be shown in Devise::Mailer,
  # note that it will be overwritten if you use your own mailer class
  # with default "from" parameter.
  config.mailer_sender = Settings.mailer.user
  ...
  # config.pepper = 'f47f8e01bb9edc21728c98d91daabef3d56dad9c35ae6bff766dfa371a8
  # 93d4ca90a5e1770e3bbd9b741971ffa3347f0abddd41b5d31774e519addae175720ee'
